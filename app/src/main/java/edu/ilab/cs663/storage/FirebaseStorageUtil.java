package edu.ilab.cs663.storage;
...
import edu.ilab.cs663.data.CrowdRecord;
import edu.ilab.cs663.data.IRRecord;
import edu.ilab.cs663.data.MaskRecord;
import edu.ilab.cs663.data.SocDistRecord;
 ...
 * Note the class edu.ilab.cs663.data.FireStoreHelper is the helper class for doing the Firestore record database insertion and is called appropriately in this class
